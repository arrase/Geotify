package dev.arrase.geonotes.ui
...
class GeoNotesViewModel(private val repository: GeoNotesRepository) : ViewModel() {
    ...
    class Factory(private val repository: GeoNotesRepository) : ViewModelProvider.Factory {
        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel> create(modelClass: Class<T>): T =
            GeoNotesViewModel(repository) as T
    }
}
