...
- **Location Management**: Save current GPS coordinates or pick custom coordinates interactively using an embedded **Map Picker**, with support for custom location aliases (e.g., *'home'*, *'gym'*, *'mom's house'*) and custom geofence radii (minimum 50 meters, defaults to 150 meters).
